...
<script>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a class="btn btn-danger btn-sm btn-hapus" data-id="' + data + '" data-handler="kecamatan" href="<?= url('data/kecamatan/delete') ?>/' + data + '">\
                        <span class="fa fa-trash"></span> Hapus</a> \
					    <form id="delete-form-' + data + '-kecamatan" action="<?= url('data/kecamatan/delete') ?>/' + data + '" \
    ...
    $("body").on("click", ".btn-edit", function() {
        ...
        $.ajax({
            url: "<?= url('data/kecamatan'); ?>/getjson/" + id,
            type: "GET",
            cache: false,
            dataType: 'json',
        ...
        jQuery("#compose-form").attr("action", '<?= url('data/kecamatan'); ?>/update/' + id);
