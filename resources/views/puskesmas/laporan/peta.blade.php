...
<script type="text/javascript">
    ...
    var newData = kecKotaMedan.features;
    var gogjson;
    var thisMap;
    var thisSector = '<?= $sectorArea ?>';
    $(function() {
        $.each(newData, function(index, row) {
            //console.log(row);
            if (row.properties.name === thisSector) {
                var noMap = new Array(row);
                thisMap = noMap;
                geojson = L.geoJson(thisMap, {
                    style: style,
