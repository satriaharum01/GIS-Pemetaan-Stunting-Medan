...
<script>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a class="btn btn-danger btn-sm btn-hapus" data-id="' + data + '" data-handler="upt" href="<?= url('data/upt/delete') ?>/' + data + '">\
    ...
    $("body").on("click", ".btn-edit", function() {
        ...
        jQuery("#compose-form").attr("action", '<?= url('data/upt'); ?>/update/' + id);
